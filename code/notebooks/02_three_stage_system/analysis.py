...
SystemMetrics = namedtuple(
    "Metrics", ["lost_messages", "rejected_messages", "output_age_min", "output_age_max", "output_age_avg"]
)
...
class DataLogger(object):
    ...
    def reset(self):
        ...
        self.mt_rejected_messages = MovingTotal(self.window_size)
    ...
    def log_system_metrics(self, time: int, metrics: SystemMetrics):
        ...
        self.mt_rejected_messages.push(metrics.rejected_messages)
        ...
        self.rejected_messages.append(self.mt_rejected_messages.value)
    ...
    def write_to_tensorboard(self):
        ...
        self.tensorboard_writer.add_scalar(
            "system/rejected_messages", self.mt_rejected_messages.value, self.sys_time[-1]
        )
